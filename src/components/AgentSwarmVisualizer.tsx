// src/components/AgentSwarmVisualizer.tsx
...
const MOCK_AGENTS_DATA = [
    ...
    { id: 'ui_01', type: 'UI Gen', status: 'idle' },
];
        ...
        const interval = setInterval(() => {
            setAgents(prev => {
                ...
                return prev.map(agent => ({ 
                    ...agent, 
                    status: ['idle', 'waiting', 'processing', 'active'][Math.floor(Math.random() * 4)] 
                }));
            });
        }, 2500);
                        ...
                        >
                            <div className="relative">
                                ...
                                {agent.status === 'processing' && (
                                    <div className="absolute top-0 right-0 -mt-1 -mr-1 w-4 h-4 rounded-full bg-blue-500 animate-ping" />
                                )}
                            </div>
