// src/components/ProjectIntakeForm.tsx
    ...
    if (status === 'success') {
        return (
            <div className="text-center p-6 bg-green-50 rounded-lg border border-green-200">
                ...
                <p className="mt-2 text-gray-700">Your project has been submitted to the agent swarm. Watch the real-time processing on the right.</p>
            </div>
        );
    }
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            <div className="text-center">
                <h3 className="text-2xl font-bold text-gray-800">Describe Your Project</h3>
            </div>
            
            <textarea 
                name="raw_description" 
                rows={8} 
                placeholder="e.g., 'I want to remodel my master bathroom. This includes a walk-in shower, new double vanity, and new floor tiles.'" 
                required 
                className="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 transition"
            />
            
            <h3 className="text-2xl font-bold text-gray-800 text-center">Your Contact Information</h3>
            ...
            <button 
                ...
                className="w-full bg-blue-600 text-white p-4 rounded-md font-bold text-lg hover:bg-blue-700 transition disabled:bg-gray-400"
            >
