# BUILD ME 9 - Agent 3 - Project Scope

Instructions for Execution Agent: This document contains the complete and final code for the Project Scope agent. Your task is to populate the existing files within the agents/project_scope/ directory with the code provided below. DO NOT create new files or modify any logic.
